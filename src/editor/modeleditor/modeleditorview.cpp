...
ModelEditorView::ModelEditorView(Root *root, ModelEditor *modelEditor, Qt::WindowFlags f, Ogre::SceneType ogreSceneType, const Ogre::NameValuePairList *ogreParameters)
