...
#ifndef WC3LIB_EDITOR_DOODADDATA_HPP
#define WC3LIB_EDITOR_DOODADDATA_HPP
...
class KDE_EXPORT DoodadData : public ObjectData
{
	public:
		DoodadData(MpqPriorityList *source, QObject *parent = 0);
		...
		MetaData* doodadData() const;

	private:
		MetaDataPtr m_metaData;
		MetaDataPtr m_doodadData;
};

inline MetaData* DoodadData::metaData() const
{
	return this->m_metaData.data();
}

inline MetaData* DoodadData::doodadData() const
{
	return this->m_doodadData.data();
}
