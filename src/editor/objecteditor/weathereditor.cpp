...
WeatherEditor::WeatherEditor(MpqPriorityList* source, ObjectData *objectData, ObjectEditor *objectEditor, QWidget *parent) : ObjectEditorTab(source, objectData, "weathereditor", objectEditor, parent)
{
	setupUi();
}
