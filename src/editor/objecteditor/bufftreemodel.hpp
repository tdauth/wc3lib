...
#ifndef WC3LIB_EDITOR_BUFFTREEMODEL_HPP
#define WC3LIB_EDITOR_BUFFTREEMODEL_HPP
...
class BuffTreeModel : public ObjectTreeModel
{
	public:
		BuffTreeModel(MpqPriorityList *source, QWidget *window, QObject *parent = 0);
	...
	protected:
		...
		QModelIndex buffTypeIndex(ObjectData *objectData, const QString &originalObjectId, const QString &customObjectId);
...
#endif // WC3LIB_EDITOR_BUFFTREEMODEL_HPP
