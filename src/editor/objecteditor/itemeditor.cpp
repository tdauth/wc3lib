...
ItemEditor::ItemEditor(MpqPriorityList *source, ObjectData *objectData, ObjectEditor *objectEditor, QWidget *parent) : ObjectEditorTab(source, objectData, "itemeditor", objectEditor, parent)
{
	setupUi();
}
