...
#ifndef WC3LIB_EDITOR_UPGRADETREEMODEL_HPP
#define WC3LIB_EDITOR_UPGRADETREEMODEL_HPP
...
{
	public:
		UpgradeTreeModel(MpqPriorityList *source, QWidget *window, QObject *parent = 0);
