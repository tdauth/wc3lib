...
#ifndef WC3LIB_EDITOR_SKINTREEMODEL_HPP
#define WC3LIB_EDITOR_SKINTREEMODEL_HPP
...
/**
 * \brief The concrete tree model for skin data.
 * \ingroup objectdata
 */
class SkinTreeModel : public ObjectTreeModel
{
	public:
		SkinTreeModel(MpqPriorityList *source, QWidget *window, QObject *parent = 0);
...
#endif // WC3LIB_EDITOR_SKINTREEMODEL_HPP
