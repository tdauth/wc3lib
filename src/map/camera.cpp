...
std::streamsize Camera::read(std::basic_istream<byte> &istream) throw (class Exception)
{
...
std::streamsize Camera::write(std::basic_ostream<byte> &ostream) const throw (class Exception)
{
	std::streamsize size = 0;
