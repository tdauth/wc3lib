...
GeosetAnimationColors::GeosetAnimationColors(class GeosetAnimation *geosetAnimation) : MdlxScalings(geosetAnimation->geosetAnimations()->mdlx(), "KGAC", "Color"), m_geosetAnimation(geosetAnimation)
{
}
