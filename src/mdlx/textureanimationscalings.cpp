...
TextureAnimationScalings::TextureAnimationScalings(class TextureAnimation *textureAnimation) : MdlxScalings(textureAnimation->textureAnimations()->mdlx(), "KTAS", "Scaling"), m_textureAnimation(textureAnimation)
{
}
