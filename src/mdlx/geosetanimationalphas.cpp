...
GeosetAnimationAlphas::GeosetAnimationAlphas(class GeosetAnimation *geosetAnimation) : MdlxAlphas(geosetAnimation->geosetAnimations()->mdlx(), "KGAO", "Alpha"), m_geosetAnimation(geosetAnimation)
{
}
