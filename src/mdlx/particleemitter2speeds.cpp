...
ParticleEmitter2Speeds::ParticleEmitter2Speeds(class ParticleEmitter2 *particleEmitter) : MdlxAlphas(particleEmitter->particleEmitters()->mdlx(), "KP2S", "Speed"), m_particleEmitter(particleEmitter)
{
}
