...
RibbonEmitterVisibilities::RibbonEmitterVisibilities(class RibbonEmitter *ribbonEmitter) : MdlxAlphas(ribbonEmitter->ribbonEmitters()->mdlx(), "KRVS", "Visibilities"), m_ribbonEmitter(ribbonEmitter)
{
}
