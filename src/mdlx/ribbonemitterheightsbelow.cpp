...
RibbonEmitterHeightsBelow::RibbonEmitterHeightsBelow(class RibbonEmitter *ribbonEmitter) : MdlxAlphas(ribbonEmitter->ribbonEmitters()->mdlx(), "KRHB", "HeightBelow"), m_ribbonEmitter(ribbonEmitter)
{
}
