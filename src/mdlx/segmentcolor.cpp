...
std::streamsize SegmentColor::readMdl(istream &istream) throw (class Exception)
{
	return 0;
}
...
std::streamsize SegmentColor::writeMdx(ostream &ostream) const throw (class Exception)
{
	std::streamsize size = 0;
