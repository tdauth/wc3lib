 ...
 * Class \ref Parser can be used for full parsing/syntax validation.
 * \ref Compiler provides methods for compilation into other scripting languages etc.
 * \ref Optimizer is able to run specific optimizations on the AST.
 * 
