#define BOOST_TEST_MODULE StatementsErrorsTest
...
BOOST_AUTO_TEST_CASE(Set) {
	const char* jassFile = "statements_set_errors.j";
	const char* traceFile = "statements_set_errors_traces.xml";
...
//		std::cerr << client::expectationFailure(e) << std::endl;
	...
	BOOST_REQUIRE(grammar.reports.size() == 2);
}
