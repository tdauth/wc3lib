...
* 
* The wc3lib is divided into the following parts:
* <ul>
...
* 
* The class easily be used to convert one format into the other one (application "wc3converter" provides this feature).
* 
